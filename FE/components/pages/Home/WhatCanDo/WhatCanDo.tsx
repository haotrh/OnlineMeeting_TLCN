  ...
  return (
    <>
      ...
      <div className="w-full space-y-16 font-quicksand mb-20">
        <WhatCanDoSection
          title="Meet safely"
          description="Meet uses the same protections that Google uses to secure your information
          and safeguard your privacy. Meet video conferences are encrypted in
        ...
        <WhatCanDoSection
          ...
          description={`Get the whole crew together in Google Meet, where you can present business proposals, collaborate on chemistry assignments, or just catch up face to face.\n
        ...
        <WhatCanDoSection
          ...
          mobile devices, they can join from the Google Meet app. Guests
        ...
        <WhatCanDoSection
          title="Meet clearly"
          description="Google Meet adjusts to your network speed, ensuring high quality
